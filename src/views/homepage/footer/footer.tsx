...
const Footer = () => {
  return (
    <div className="bg-[#F7FAF8]">
      <div className=" max-w-[1440px] mx-auto px-5 md:px-[120px] py-10 md:py-20 flex flex-col gap-y-8 md:flex-row justify-between">
        <div className="">
          <div className="space-y-2">
            <Image src={WebsiteLogo} alt="Website Logo" />
            <p className="text-[#017356] text-lg md:text-2xl font-semibold md:leading-[29px]">ShopBraze </p>
          </div>
          <p className="mt-3 md:mt-4 text-[#0B4627] text-sm md:text-base font-medium">
          ...
          <div className="mt-4 md:mt-6 flex gap-2 items-center">
            ...
            <p className="text-[#525866] text-sm md:text-base font-medium whitespace-nowrap">2025 ShopBraze, Inc. All rights reserved.</p>
          </div>
        </div>
